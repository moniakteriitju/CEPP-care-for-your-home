 ...
 <!--    "**********************************" -->
  ...
  <div class="col-sm-8 text-left"> 
     ...
     <div class="container">
        ...
        <div class="heading"> <h2>Our Plumbers</h2></div>
  ...
  <div class="heading"> <h2>Our Carpenters</h2></div>
  <div>
	...
	<tr >
      ...
      <div class="dtable3">
          ...
          <div class="heading"> <h2>Our Painters</h2></div>
          <div>
  ...
  <table class="table table-hover">
	...
	<tr>
       ...
       <div class="dtable4">
         ...
         <div class="heading"> <h2>Our Electricians</h2></div>
